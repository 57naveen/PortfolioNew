...
export const HeroSection = () => { 
  return <div className='py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip'>
    ...
    <div className='absolute  inset-0 -z-30 opacity-5' style={{background:`url(${grainImage.src})`}}></div>
   ...
   <HeroOrbit size={430} rotation={-14} shouldOrbit orbitDuration='30s' shouldSpin  spinDuration='3s'  >
    <SparkleIcon className="size-8 text-emerald-300/20" />
      ...
      <HeroOrbit size={580} rotation={20} shouldOrbit orbitDuration='40s' shouldSpin  spinDuration='6s' >
    ...
    <div className="container">
      <div className='flex flex-col items-center'>
        ...
        <p className='mt-4 text-center text-whit/60 md:text-lg'>
          I Specialize in transforming designs into functional, high-performing web applications.let discuss your next project.
        </p>
         </div>
        <div className='flex flex-col md:flex-row justify-center items-center mt-8 gap-4'>
          ...
          <button className='inline-flex items-center gap-2 border bg-white text-gray-900 px-6 h-12 rounded-xl'><span>🖖</span><span className='font-semibold'>Let Connect</span></button>
        </div>
    </div>
  </div>;
};
